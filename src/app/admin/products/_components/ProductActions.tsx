...
export function ActiveToggleDropdownItem({ id, isAvailableForPurchase}: {id:string, isAvailableForPurchase:boolean}){
    ...
    const [isPending, startTransition] = useTransition() // use Transition to defer this action for more important UI updates
...
// if you have orders disabled will never be true
