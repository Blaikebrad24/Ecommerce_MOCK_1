...
const getMostPopularProducts = cache(() =>{
    return prismaDBConnection.product.findMany({ where: { isAvailableForPurchase: true},
    orderBy: { orders: { _count: "desc"}},
    take: 6
    })
}, ["/", "getMostPopularProducts"], {revalidate: 60 * 60 * 24}) // everyday revalidate with a new value
...
type ProductGridSectionProps = {
    title: string
    productsFetcher: () => Promise<Product[]> // from prisma
}
...
// the async needs to be in a separate component
